...
double solve() {
    int no_improve = 0;
    int max_no_improve = 100 * n;

    double T_start = 5000 * n;      
    double T_min = 1e-3;
    double T = T_start;
